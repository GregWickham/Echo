...
namespace FlexibleRealization
{
    ...
    {
        /// <summary>This constructor is used when loading an element from the database</summary>
        private protected PartOfSpeechBuilder() { }

        /// <summary>This constructor is used:<list type="bullet">
        /// <item>During lightweight copy;</item>
        /// <item>By the UI when the user is changing a part-of-speech to a different part-of-speech.</item></list></summary>
        private protected PartOfSpeechBuilder(int index) { Index = index; }
        ...
        /// <summary>The ParseToken generated by the CoreNLP parser.  We extract information from the ParseToken during construction of an ElementBuilder tree, then discard it.</summary>
        public ParseToken Token { get; internal set; }

        /// <summary>The index of this part of speech within its governing syntax element, relative to other parts of speech.</summary>
